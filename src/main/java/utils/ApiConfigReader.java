...
public class ApiConfigReader {
    private static final Logger logger = LoggerFactory.getLogger(ApiConfigReader.class);
    private static final Properties properties = new Properties();
    private static final String CONFIG_PATH = "D:\\study\\playwrightproj1\\src\\test\\resources\\apiConfig.properties";
